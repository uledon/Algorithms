...
public class FileInputReader {
	...
	public FileInputReader()
	{
	    ...
	    //set the lists
	    dances = readFromFiles("astaireDataFiles/danceShowData_dances.csv");
	    dances.remove("Dance Name");
	    danceGroups = readFromFiles("astaireDataFiles/danceShowData_danceGroups.csv");
	    danceGroups.remove("Dance Group");
	    runningOrder = readFromFiles("astaireDataFiles/danceShowData_runningOrder.csv");
	...
	public static void main(String[] args)
	{
		...
		tmp5.checkTimeBetweenDances("astaireDataFiles/danceShowData_runningOrder.csv", 2);
